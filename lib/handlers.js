...
handlers._checks.post = function (data, callback) {
  ...
  if (protocol && url && method && statusCodes && timeoutSeconds) {
      ...
      if (!err && tokenData) {
        ...
        _data.read("users", userPhone, function (err, userData) {
          if (!err && userData) {
            ...
            // verify users has less than the max checks
                ...
                if (!err) {
                  ...
                  _data.update("users", userPhone, userData, function (err) {
                    if (!err) {
                      ...
                      callback(500, {
                        errMessage: "couldn't save the users checks",
                      });
                    }
                  });
                } else {
            ...
            callback(403, {
              errorMessage: "User has already maximum number of checks",
            });
          }
        });
      } else {
    ...
    callback(400, { errMessage: "Invalid or missing fields" });
  }
};
// Export the handlers
